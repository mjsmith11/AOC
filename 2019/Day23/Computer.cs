...
namespace Day23 {
    public class Computer {
        ...
        public Int64[] execute(List<long> inputs) {
            if(halted) {
            ...
            while (opcode != 99) {
                ...
                if (opcode==1) {
                    ...
                    if (nextInput == inputs.Count) { return outputs; }
                    //Console.WriteLine("inputting " + inputs[nextInput]);
                    ...
                    //Console.WriteLine("Outputting " + lastOutput);
                    // end signal
                    outputs[nextOutput + 1] = -1;
                    outputs[nextOutput + 2] = -1;
                    outputs[nextOutput + 3] = -1;
                    nextOutput++;
                    pc = pc + 2;
