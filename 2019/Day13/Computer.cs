...
namespace Day13 {
    public class Computer {
        ...
        public Int64[] execute(Int64 input1, Int64 input2) {
            if(halted) {
                Console.WriteLine("Tried to run halted program");
                return new Int64[3];
            }
            Int64[] outputs = new Int64[3];
            int nextOutput = 0;
            Int64 nextInput = input1;
            ...
            while (opcode != 99) {
                ...
                if (opcode==1) {
                    ...
                    positions[loc1  + getRelativeBase(getMode1(instruction))] = nextInput; 
                    nextInput = input2;
                     pc = pc + 2;
                } else if (opcode == 4) { 
                    ...
                    nextOutput++;
                    pc = pc + 2;
                    if (nextOutput==3) { return outputs; }
                } else if (opcode == 5) {
