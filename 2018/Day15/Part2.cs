...
namespace ConsoleApp1
{
    class Program
    {
        // Part 2 is largely a guess and check operation. I set elfPower to different numbers looking for the lowest number where "Elf Died" doesn't get printed before "End of Combat!!!"
            ...
            for (int y = 0; y < lines.Length; y++)
            {
                ...
                for (int x = 0; x < s.Length; x++)
                {
                    ...
                    if (s[x] == 'E' || s[x] == 'G')
                    {
                        ...
                        u.loc.y = y;
                        u.hp = 200;
                        u.attackPower = u.type=='E'?elfPower:3;
                        units.Add(u);
                    }
                }
            }
                ...
                foreach (Unit u in units)
                {
                    ...
                    if (attackEnemy != null)
                    {
                        ...
                        if (attackEnemy.hp <= 0)
                        {
                            ...
                            if (attackEnemy.type == 'E') { Console.WriteLine("Elf Died"); }
                            attackEnemy.hp = 0;
                        }
                    }
                }
